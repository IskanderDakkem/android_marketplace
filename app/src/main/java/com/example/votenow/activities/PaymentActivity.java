...
public class PaymentActivity extends AppCompatActivity {
    ...
    void processCOD(){
        new AlertDialog.Builder(this)
                ...
                .setMessage("Your products will be shipped within 24 hours. " +
                        "You can pay " + total + " TND to the courier when you recieve the products at your doorstep.")
    ...
    void processbkash(){
        new AlertDialog.Builder(this)
                .setTitle("Bkash")
                .setCancelable(false)
                .setMessage("Place your payment of " + total + " TND through cash delivery to 01608504435 within 2 hours with this Order no. Your products will then be shipped within 24 hours. " +
    ...
    void processnagad(){
        new AlertDialog.Builder(this)
                .setTitle("Nagad")
                .setCancelable(false)
                .setMessage("Place your payment of " + total + " TND through us to 01804879621 within 2 hours with this Order no. Your products will then be shipped within 24 hours. " +
                        "If you do not pay within 2 hours, your order will be cancelled.")
                .setPositiveButton("Confirm Order", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    void processrocket(){
        new AlertDialog.Builder(this)
                .setTitle("Rocket")
                .setCancelable(false)
                .setMessage("Place your payment of " + total + " TND through Rocket to 01754317077 within 2 hours with this Order no. Your products will then be shipped within 24 hours. " +
                        "If you do not pay within 2 hours, your order will be cancelled.")
                .setPositiveButton("Confirm Order", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
